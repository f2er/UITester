...
KISSY.ready(function(S) {
	...
	if($('#weeks').length && $('#weeks')[0].tagName == 'SPAN') {
		...
		var value = S.map(ids.split(','), function(id) {
			return '星期' + ['','一','二','三','四','五','六','七'][S.trim(id)];
		}).join(', ');
		$('#weeks').html(value);
	}
});
