...
var ClientPool = {
    ...
    _updateInfo: function (clientObject, action){
        ...
        console.log(host.summary, host.clientsMap);
    },
...
var ClientManager = {
    listenEventMap: {
        'client:register': function (clientObject){
            // console.log('[ClientMgr Event] client register');
        ...
        'client:available': function (clientType){
            console.log('[ClientMgr Event] available client:', clientType);
        ...
        'task:start': function (taskObject, clientType){
            ...
            console.info('[send a task to ', clientType);
            clientObject.socket.emit('console:task_start', 'test');
        }
    },
