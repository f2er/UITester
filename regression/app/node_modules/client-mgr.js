...
var ClientPool = {
    ...
    addClient:function (client) {
        var host = this;
        var clientType = host.getUA(client.userAgent.browser);
        var summary = host.summary;
        //9.0 go 9

        if (clientType.indexOf(".") != -1) {
            clientType = clientType.substring(0, clientType.indexOf("."))
        }
        ...
        io.sockets.on('connection', function (socket) {
            ...
            socket.on('console:register', function (data) {
                    ...
                    run:function (task, complete, timeout) {
                        if (clientObject.status == "free") {
                            ...
                            clientObject.disconnect = function () {
                                ...
                                console.log(clientObject + " disconnect")
                                if (!isComplete) {
                ...
                clientObject.socket.on('console:task_finish', function (data) {
                    console.log("console:task_finish",data,clientObject.userAgent)
