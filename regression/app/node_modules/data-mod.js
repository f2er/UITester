...
function _findByTime(){
	var d = new Date();
	var day = d.getDay();
	return "select `id`,`task_result`,`creator`, `task_inject_uri`, `duration`  from list where locate('"+day+"',week) > 0 and next_time < now()";
}
