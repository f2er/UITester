...
beforeEach(function () {
    var uiMatchers = {
        ...
        toHaveComputedStyle:function (styleProp, expectValue) {
            ...
            return $(this.actual).first().css(styleProp) === expectValue;
        ...
        willAddChild       :function (selector) {
            ...
            var parent = $(this.actual)[0];

            if ($(selector, this.actual)[0]) {
                $(selector, this.actual).first().data("_mark_" + num, true)
            }


            this.verify = jasmine.Matchers.matcherFn_('willAddChild', function () {

                if (!parent && $(this.actual)[0] && $(selector, this.actual)[0])return true;
              
                return  $(selector, this.actual)[0] && !$(selector).first().data("_mark_" + num);
            });
            return this;
        },
        willRemoveChild    :function (selector) {
            ...
            $(selector, this.actual).data("_mark_" + num, true)


            this.verify = jasmine.Matchers.matcherFn_('willAddChild', function () {
                return  !$(selector, this.actual)[0] || !$(selector, this.actual).first().data("_mark_" + num);
            });
            return this;
        },
        ...
        willAddAttr        :function (attrName, attrValue) {
            ...
            this.verify = jasmine.Matchers.matcherFn_('willAddAttr', function () {
                ...
                return  $(this.actual).attr(attrName) === attrValue;
            });
            return this;
        },
        willModifyAttr     :function (attrName, newValue) {
            ...
            this.verify = jasmine.Matchers.matcherFn_('willModifyAttr', function () {
                return  $(this.actual).attr(attrName) === newValue;
            });
            return this;
        },
        ...
        willRemoveAttr     :function (attrName) {
            ...
            // 记录下传入节点的子元素信息 innerHTML
            this.record = $(this.actual).attr(attrName);
            // 验证节点子元素是否增加了selector所指定的节点. 个数是否一致

            this.verify = jasmine.Matchers.matcherFn_('willRemoveAttr', function () {
                return  !$(this.actual).attr(attrName);
            });
            return this;
        },
        willModifyInnerHTML:function (newValue) {
            ...
            this.verify = jasmine.Matchers.matcherFn_('willModifyInnerHTML', function () {
                return  $(this.actual).html() === newValue;
            });
            return this;
        }
    };
